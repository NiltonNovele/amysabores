...
export const products: ProductType[] = [
  ...
  },
  {
    ...
    images: { "#C11B17": "/products/5.0.jpeg", "#A1120B": "/products/5.0.jpeg" },
    category: "bolos",
  },
  {
    id: 6,
    name: "Orelhudos",
    shortDescription: "Orelhudos",
    description:
      "Mini cheesecakes delicados, feitos artesanalmente em sabores como morango, chocolate e maracujá.",
    price: 700,
    sizes: ["Unidade", "Dúzia"],
    colors: ["#F9E79F", "#D6AEDD"],
    images: { "#F9E79F": "/products/6.0.jpeg", "#D6AEDD": "/products/6.0.jpeg" },
    category: "doces-especiais",
  },
  {
    id: 7,
    name: "Bolo de cenoura",
    shortDescription: "Bolo de cenoura com chocolate",
    description:
      "Cupcakes de morango artesanais com cobertura de creme e pedaços de morango fresco.",
    price: 750,
    sizes: ["Unidade", "Dúzia"],
    colors: ["#F28DA3", "#E75480"],
    images: { "#F28DA3": "/products/7.0.jpeg", "#E75480": "/products/7.0.jpeg" },
    category: "cupcakes",
  },
  {
    id: 8,
    name: "Mini bolo",
    shortDescription: "Mini bolo",
    description:
